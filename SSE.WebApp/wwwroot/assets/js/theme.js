...
$(document).ready(function () {
    $(".exp-mark").mouseover(function (el) {
        $(el.currentTarget).parent().find(".exp-text").attr("style", "display:initial");
    });
    $(".exp-mark").mouseout(function (el) {
        $(el.currentTarget).parent().find(".exp-text").removeAttr("style");
    });
